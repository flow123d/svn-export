...
//	    ar & bc_mark_type_;
	    ...
	    ar & cfl_max_step;
	            // only local part
//	    ar & conc; //double ***conc;
//	    ar & pconc; //double ***pconc;
//	    ar & cumulative_corr; //double **cumulative_corr;
...
//	    ar & out_conc; //double ***out_conc;
	    ar & n_substances;    // # substances transported by water
//	    ar & substance_name;   // Names of substances //char            **substance_name;

	            //Density
	    ar & density;           // Density Yes/NO
//	    ar & prev_conc; //double ***prev_conc;
//	    ar & scalar_it; //double *scalar_it;
//	    ar & substance_density_scale; //double          *substance_density_scale;
//
...
//	            Vec *vsources_sigma;
//	            Vec *vsources_conc;
//	        ar & vsources_corr;//	            Vec *vsources_corr;
//	        ar & vcumulative_corr; //	            Vec *vcumulative_corr;
//
//
//	            ar & vconc_out; //Vec *vconc_out; // concentration vector output (gathered)
